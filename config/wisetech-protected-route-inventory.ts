...
export const protectedRouteOwnershipInventory: readonly ProtectedRouteOwner[] = Object.freeze([
  ...
  owner({id: "admin-check-in", family: "admin", classification: "admin-page", routePath: "/admin/check-in/[token]", filePath: "app/[locale]/(admin)/admin/check-in/[token]/page.tsx", dataOwner: "Staff check-in of one ticket seat, reached only by scanning a signed pass (Phase D-4b)."}),
  owner({id: "admin-inbox", family: "admin", classification: "admin-page", routePath: "/admin/inbox", filePath: "app/[locale]/(admin)/admin/inbox/page.tsx", dataOwner: "Staff read-only concierge conversation list (Phase A)."}),
  owner({id: "admin-inbox-thread", family: "admin", classification: "admin-page", routePath: "/admin/inbox/[id]", filePath: "app/[locale]/(admin)/admin/inbox/[id]/page.tsx", dataOwner: "Concierge conversation transcript selected by id."}),
  owner({id: "admin-tasks", family: "admin", classification: "admin-page", routePath: "/admin/tasks", filePath: "app/[locale]/(admin)/admin/tasks/page.tsx", dataOwner: "Open staff-task queue with resolve action."}),
  ...
  owner({id: "admin-profiles-review", family: "admin", classification: "admin-page", routePath: "/admin/profiles-review", filePath: "app/[locale]/(admin)/admin/profiles-review/page.tsx", dataOwner: "Staff review of public member pages (Phase B2)."}),
  ...
  owner({id: "api-og", family: "api", classification: "api-handler", routePath: "/api/og", filePath: "app/api/og/route.tsx", dataOwner: "Public social share-card renderer; reads no database, drawing only from bounded query parameters (Phase D)."}),
  owner({id: "api-admin-event-attendees-csv", family: "api", classification: "api-handler", routePath: "/api/admin/events/[id]/attendees.csv", filePath: "app/api/admin/events/[id]/attendees.csv/route.ts", dataOwner: "Audited merged member+guest attendee CSV export (Phase B1, B-4)."}),
  ...
  owner({id: "api-job-event-cancellation-refunds", family: "api", classification: "job-handler", routePath: "/api/jobs/event-cancellation-refunds", filePath: "app/api/jobs/event-cancellation-refunds/route.ts", dataOwner: "Authenticated sweep refunding the paid orders of a cancelled event (Phase D-4d)."}),
  owner({id: "api-job-showcase-lead-emails", family: "api", classification: "job-handler", routePath: "/api/jobs/showcase-lead-emails", filePath: "app/api/jobs/showcase-lead-emails/route.ts", dataOwner: "Authenticated ten-minute recovery of queued showcase introduction notices."}),
  owner({id: "api-job-ticket-emails", family: "api", classification: "job-handler", routePath: "/api/jobs/ticket-emails", filePath: "app/api/jobs/ticket-emails/route.ts", dataOwner: "Authenticated minute recovery of queued ticket purchase and refund notices."}),
