...
- [ ] Submit `wtia_event_reminder_24h` and `wtia_event_confirmation_*` to Woztell/Meta with the Phase A template batch (spec §8.3); until approved, reminders go by email only.
