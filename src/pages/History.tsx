...
const eras = [
  {
    ...
    milestones: [
      { year: "2001", title: "Foundation", desc: "WTIA is officially established by industry leaders to facilitate cooperation among telecoms, hardware manufacturers, and developers." },
      { year: "2002", title: "The SafeWiFi Project", desc: "Long before cybersecurity was a boardroom topic, WTIA launched \"SafeWiFi.\" In a famous ongoing initiative, WTIA experts rode Hong Kong's tram networks with scanning equipment to audit public Wi-Fi security. This project successfully forced the improvement of public network safety protocols city-wide." },
    ],
  },
  {
    num: "02",
    ...
    milestones: [
      { year: "ASA", title: "Asia Smart App Awards", desc: "WTIA foresaw the app economy boom and created the ASA. Supported by government funding, this platform united 17 Asian regions, giving Hong Kong developers a direct pipeline to international markets and investors." },
      { year: "HKICT", title: "HKICT Awards (Startup Sector)", desc: "WTIA became a leading organizer of the Hong Kong ICT Awards. By championing the \"ICT Startup\" category, WTIA bridged the gap between early-stage tech innovators and enterprise buyers seeking fresh solutions." },
    ],
  },
  {
    num: "03",
    ...
    milestones: [
      { year: "T2C", title: "The \"Tech to Connect\" Series", desc: "WTIA launched this flagship program to cut through the hype. Rather than theoretical talks, Tech to Connect provided industry-oriented technical workshops, directly matching solution providers with enterprise decision-makers to accelerate O2O, e-commerce, and 5G deployment." },
      { year: "20+1", title: "21st Anniversary", desc: "Coming out of the pandemic, WTIA released its 21st-anniversary commemorative book, reaffirming its mandate to help Hong Kong businesses survive and scale through rapid digital transformation." },
    ],
  },
  {
    num: "04",
    ...
    milestones: [
      { year: "CPAI", title: "GenAI Certification", desc: "In partnership with CUSCS, WTIA launched the Certified Practitioner in Generative AI for Business Innovation—professionalizing AI adoption for the corporate workforce." },
      { year: "2025", title: "Asia Smart Innovation Awards", desc: "WTIA expanded its flagship awards into the Asia Smart Innovation Awards, recognizing that the future is no longer just about \"apps,\" but integrated AI, spatial computing, media, and digital art." },
      { year: "2026", title: "25th Anniversary & Innovate Hong Kong", desc: "Today, under the leadership of Chairman Keith Li, WTIA evolves into Innovate Hong Kong — a cross-border platform bridging GBA innovation to the global stage, serving hundreds of corporate members across Hong Kong, the Greater Bay Area, and Asia." },
    ],
  },
];
...
const stats = [
  ...
  { value: "17", label: "Asian regions connected through WTIA-led platforms and awards", suffix: "Regions", icon: Globe, extra: "+" },
  { value: "100", label: "Corporate members spanning GBA telecoms to global AI startups", suffix: "Members", icon: Users, extra: "s" },
  { value: "10", label: "Professionals trained, connected, and elevated through programmes", suffix: "Professionals", icon: Award, extra: "K+" },
];
              ...
              <div className="grid md:grid-cols-12 gap-8">
                <div className="md:col-span-7 md:col-start-6 space-y-6">
                  {era.milestones.map((m, j) => (
                    <ScrollReveal key={j} delay={j * 150} direction="left">
            ...
            <ScrollReveal key={i} delay={i * 150}>
              <div className="bg-card/40 p-8 text-center hover:bg-card/70 transition-colors duration-500 group">
                ...
                <p className="text-4xl md:text-5xl font-bold gradient-text mb-2">
                  <AnimatedCounter value={s.value} suffix={s.extra || ""} />
                </p>
