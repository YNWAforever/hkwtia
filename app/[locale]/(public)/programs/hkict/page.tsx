...
export async function generateMetadata({params}: Props): Promise<Metadata> {
  ...
  return buildPageMetadata({locale: locale as AppLocale, pathname: '/programs/hkict', title: brandedTitle(locale as AppLocale, t('title')), description: t('description'), image: program.image});
}
