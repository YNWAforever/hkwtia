...
const keys=["eyebrow","title","description","currentMonth","partialMonth","lastUpdated","fresh","stale","empty","unavailable","notEnoughData","conversations","resolved","firstResponse","csat","escalation","failure","hoursSaved","llmCost","responses","samples","hours","resolutionTarget","csatTarget","renewalHeading","overallRenewal","firstYearRenewal","overallTarget","firstYearTarget","renewalChartTitle","renewalChartDescription","month","paid","due","rate","methodologyHeading","methodologyDescription","architectureHeading","architectureDescription","architectureMemberFlow","architectureJobFlow","architectureWeb","architectureConciergeRuntime","architectureGuardedTools","architectureWorker","architectureJobRoutes","architectureScheduledAgents","architectureDatabase","approvalGate","publicationGate","evidenceHeading","buildLogs","source","commits","deployment","acceptance","noBuildLogs"] as const;
