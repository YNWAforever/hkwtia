...
export default async function PrivacyPage({params}: Props) {
  ...
  const [t, common, tRoot] = await Promise.all([
    ...
    // Unscoped: the breadcrumb label keys are fully qualified (`Common.breadcrumbPrivacy`).
  ...
  return (
    <>
      ...
      <StructuredData data={buildBreadcrumbData(routeBreadcrumbItems(locale as AppLocale, '/privacy', tRoot))} />
    </>
  );
}
