...
export default async function AdminEventDetailPage({params}: Props) {
  ...
  const ordersLabels = {caption: tOrders("caption"), empty: tOrders("empty"), buyer: tOrders("buyer"), seats: tOrders("seats"), amount: tOrders("amount"), status: tOrders("status"), refundedOn: tOrders("refundedOn"), refund: tOrders("refund"), recheckRefund: tOrders("recheckRefund"), confirm: toRefundConfirmMessage(tOrders.raw("confirm")), cancel: tOrders("cancel"), note: tOrders("note"), statuses: {pending: tOrders("statuses.pending"), paid: tOrders("statuses.paid"), expired: tOrders("statuses.expired"), failed: tOrders("statuses.failed"), refunded: tOrders("statuses.refunded"), refund_failed: tOrders("statuses.refund_failed")}};
