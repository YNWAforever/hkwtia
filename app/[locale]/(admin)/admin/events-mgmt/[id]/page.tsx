...
export default async function AdminEventDetailPage({params}: Props) {
  ...
  const attendeeLabels = {caption: t("attendees"), kind: t("kind"), kinds: {member: t("kinds.member"), guest: t("kinds.guest"), ticket: t("kinds.ticket")}, name: t("name"), email: t("email"), organisation: t("organisation"), status: t("status"), checkedIn: t("checkedIn"), checkIn: t("checkIn"), checkingIn: t("checkingIn"), unavailable: t("unavailable"), statuses: {registered: t("statuses.registered"), waitlist: t("statuses.waitlist"), cancelled: t("statuses.cancelled"), attended: t("statuses.attended"), no_show: t("statuses.noShow"), paid: t("statuses.paid")}};
