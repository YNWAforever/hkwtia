...
export default async function AdminProfilesReviewPage({params}: Props) {
  ...
  // `description`, `industry` and `size_band` are here because rewriting any of
  // them from `/portal/company` is what sends a published page back into this
  // queue (`PUBLICLY_RENDERED_COLUMNS` in `lib/db/repos/companies.ts`): a
  ...
  const labels = {caption: t("caption"), company: t("company"), slug: t("slug"), tags: t("tags"), preview: t("preview"), approve: t("approve"), reject: t("reject"), rejectionReason: t("rejectionReason"), empty: t("empty"), taglineEn: t("taglineEn"), taglineZhHk: t("taglineZhHk"), descriptionEn: t("descriptionEn"), descriptionZhHk: t("descriptionZhHk"), industry: t("industry"), sizeBand: t("sizeBand"), website: t("website"), previewEmpty: t("previewEmpty")};
