DROP MATERIALIZED VIEW "public"."aiops_monthly_metrics";--> statement-breakpoint
CREATE MATERIALIZED VIEW "public"."aiops_monthly_metrics" AS (
  WITH settings AS (
    SELECT
...
-- Concurrent refresh requires an unconditional unique index on every materialized-view row.
CREATE UNIQUE INDEX "aiops_monthly_metrics_month_start_unique"
  ON "public"."aiops_monthly_metrics" ("month_start");
