...
describe("staff Showcase review", () => {
  ...
  it("renders review rows with explicit accessible controls", () => {
    render(<ShowcaseReviewTable listings={[row]} labels={{caption: "Listings", company: "Company", slug: "Slug", status: "Status", premium: "Premium", publish: "Publish", reject: "Reject", rejectionReason: "Rejection reason", savePremium: "Save premium"}} publishAction={async () => undefined} rejectAction={async () => undefined} premiumAction={async () => undefined} />);
