...
describe("accessible segment save state", () => {
  it("renders allowlisted preserved values, field associations, and an aria-live recovery message", () => {
    const html = renderToStaticMarkup(<SegmentSaveFormView
      action={vi.fn()}
      filter={{profileIds: [], tier: [], status: [], scoreMin: null, scoreMax: null, renewalWithinDays: null, sector: "", lastLoginBeforeDays: null, whatsappOptIn: null, industryTags: [], companyPlan: [], event: null, audience: "members", contactStage: [], contactSource: []}}
