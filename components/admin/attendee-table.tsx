...
type Labels = Readonly<{caption: string; kind: string; kinds: Readonly<{member: string; guest: string}>; name: string; email: string; organisation: string; status: string; checkedIn: string; checkIn: string; checkingIn: string; unavailable: string; statuses: Readonly<Record<string, string>>}>;
