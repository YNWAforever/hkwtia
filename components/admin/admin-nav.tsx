...
export type AdminNavLabels = Readonly<{brand: string; label: string; members: string; segments: string; atRisk: string; events: string; announcements: string; news: string; pageCopy: string; media: string; listingsReview: string; cohorts: string; approvals: string; reports: string; automations: string}>;
