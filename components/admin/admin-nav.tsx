...
export type AdminNavLabels = Readonly<{brand: string; label: string; members: string; segments: string; atRisk: string; events: string; news: string; pageCopy: string; listingsReview: string; cohorts: string; approvals: string; reports: string; automations: string}>;
...
export function AdminNav({locale, labels}: {locale: AppLocale; labels: AdminNavLabels}) {
  const items = [
    ...
    {href: "/admin/at-risk", label: labels.atRisk}, {href: "/admin/events-mgmt", label: labels.events}, {href: "/admin/news", label: labels.news}, {href: "/admin/page-copy", label: labels.pageCopy}, {href: "/admin/listings-review", label: labels.listingsReview}, {href: "/admin/cohorts", label: labels.cohorts},
